...
namespace LsrpStreetNamesHud.GtaApi
{
    ...
    internal static class UdfBasedApi
    {
        ...
        public static Coordinates? GetPlayerCoordinates()
        {
            ...
            {
                X = Internal.readFloat(Internal.hGTA, new IntPtr(ADDR_POSITION_X)),
                Y = Internal.readFloat(Internal.hGTA, new IntPtr(ADDR_POSITION_Y)),
                Z = Internal.readFloat(Internal.hGTA, new IntPtr(ADDR_POSITION_Z))
            };
        ...
        public static bool IsPlayerInEscapeMenu()
        {
            ...
            var isPlayerInMenu = Internal.readDWORD(Internal.hGTA, new IntPtr(ADDR_PLAYER_IN_MENU));
        ...
        public static bool IsPlayerInAnyInterior()
        {
            ...
            var interiorId = Internal.readDWORD(Internal.hGTA, new IntPtr(ADDR_CURRENT_INTERIOR_ID));
            return interiorId > 0;
        }
        ...
        public static bool IsPlayerInAnyVehicle()
        {
            ...
            var vehicleId = Internal.readDWORD(Internal.hGTA, new IntPtr(ADDR_CURRENT_VEHICLE_ID));
            return vehicleId > 0;
        }
        ...
        public static double GetPlayerFacingAngle()
        {
            ...
            var pedStructAddress = Internal.readDWORD(Internal.hGTA, new IntPtr(ADDR_CPED_PTR));
            var facingAngle = Internal.readFloat(Internal.hGTA, IntPtr.Add(new IntPtr(pedStructAddress), PED_FACING_ANGLE_OFFSET));
